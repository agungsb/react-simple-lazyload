  ...
  (0, _createClass3.default)(ReactSimpleLazyLoad, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.state.imageState !== 'revealed' && _react2.default.createElement('img', (0, _assign2.default)({
          src: tiny,
          alt: alt || '',
          className: this.state.itemPreviewClassName
        }, rest)),
        this.state.imageState !== '' && _react2.default.createElement('img', (0, _assign2.default)({
          src: full,
